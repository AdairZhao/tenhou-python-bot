...
class HandDivider(object):
    ...
    def divide_hand(self, tiles_34, open_sets, called_kan_indices):
        ...
        # small optimization, we can't have a pair in open part of the hand_calculation,
        ...
        # let's remove closed kan sets from hand_calculation
        closed_kan_sets = []
        ...
        # let's try to find all possible hand_calculation options
        hands = []
        for pair_index in pair_indices:
            ...
            # let's find all possible hand_calculation from our valid sets
        ...
        # small optimization, let's remove hand_calculation duplicates
        unique_hands = []
        for hand in hands:
    ...
    def find_pairs(self, tiles_34, first_index=0, second_index=33):
        """
        Find all possible pairs in the hand_calculation and return their indices
    ...
    def find_valid_combinations(self, tiles_34, first_index, second_index, hand_not_completed=False):
        ...
        # lit of chi\pon sets for not completed hand_calculation
